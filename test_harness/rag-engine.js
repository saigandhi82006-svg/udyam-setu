/**
 * Udyam Setu - Client-Side Autonomous RAG & Matching Engine
 * 100% Identical Parity with Backend Services for Standalone Mobile and Offline Operation.
 */
(function(window) {
/**
...
window.COMPREHENSIVE_GOVT_SCHEMES = COMPREHENSIVE_GOVT_SCHEMES;
window.UdyamSchemes = COMPREHENSIVE_GOVT_SCHEMES;

window.UdyamMatchingEngine = {
  matchSchemesForUser: function(userProfile, schemes = COMPREHENSIVE_GOVT_SCHEMES) {
    return matchSchemesForUser(userProfile, schemes);
  }
};
...
console.log('[Udyam Setu] Autonomous Client Engine & Scheme Database Loaded (' + COMPREHENSIVE_GOVT_SCHEMES.length + ' schemes).');
})(window);
