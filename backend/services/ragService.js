...
const SECTOR_TRANSLATIONS = {
  te: {
    ...
    'Services / Commercial Transport': 'సర్వీసులు / వాణిజ్య రవాణా',
    'Services / Repair Shop': 'రిపేర్ & సర్వీస్ రంగం', 'Street Vending': 'వీధి వ్యాపారం',
    'Education / Youth': 'విద్య / యువత', 'Differently Abled / Divyangjan': 'దివ్యాంగుల సాధికారత',
    'Women Entrepreneur': 'మహిళా వ్యాపారవేత్తలు', 'Commercial Transport': 'వాణిజ్య రవాణా',
    ...
    'Food Processing / Culinary': 'ఆహార శుద్ధి / వంట రంగం', 'Artisans & Craftsmen': 'కళాకారులు & చేతివృత్తి',
    'Handloom & Textiles': 'చేనేత & వస్త్ర రంగం', 'Fisheries': 'మత్స్య పరిశ్రమ',
    'Dairy & Poultry': 'పాడి & పోల్ట్రీ', 'Agriculture': 'వ్యవసాయం',
  ...
  hi: {
    ...
    'Services / Commercial Transport': 'सेवाएं / वाणिज्यिक परिवहन',
    'Services / Repair Shop': 'मरम्मत एवं सेवा केंद्र', 'Street Vending': 'स्ट्रीट वेंडिंग',
    'Education / Youth': 'शिक्षा / युवा', 'Differently Abled / Divyangjan': 'दिव्यांगजन सशक्तिकरण',
    'Women Entrepreneur': 'महिला उद्यमी', 'Commercial Transport': 'वाणिज्यिक परिवहन',
    ...
    'Food Processing / Culinary': 'खाद्य प्रसंस्करण', 'Artisans & Craftsmen': 'कारीगर एवं दस्तकार',
    'Handloom & Textiles': 'हथकरघा एवं वस्त्र', 'Fisheries': 'मत्स्य पालन',
    'Dairy & Poultry': 'डेयरी एवं पोल्ट्री', 'Agriculture': 'कृषि',
  ...
  kn: {
    ...
    'Services / Commercial Transport': 'ಸೇವೆಗಳು / ವಾಣಿಜ್ಯ ಸಾರಿಗೆ',
    'Services / Repair Shop': 'ರಿಪೇರಿ ಮತ್ತು ಸೇವಾ ಕೇಂದ್ರ', 'Street Vending': 'ಬೀದಿ ವ್ಯಾಪಾರ',
    'Education / Youth': 'ಶಿಕ್ಷಣ / ಯುವಜನ', 'Differently Abled / Divyangjan': 'ವಿಕಲಚೇತನ ಸಬಲೀಕರಣ',
    'Women Entrepreneur': 'ಮಹಿಳಾ ಉದ್ಯಮಿ', 'Commercial Transport': 'ವಾಣಿಜ್ಯ ಸಾರಿಗೆ',
    ...
    'Food Processing / Culinary': 'ಆಹಾರ ಸಂಸ್ಕರಣ', 'Artisans & Craftsmen': 'ಕುಶಲಕರ್ಮಿಗಳು',
    'Handloom & Textiles': 'ಕೈಮಗ್ಗ ಮತ್ತು ಜವಳಿ', 'Fisheries': 'ಮೀನುಗಾರಿಕೆ',
    'Dairy & Poultry': 'ಹೈನುಗಾರಿಕೆ ಮತ್ತು ಕೋಳಿ ಸಾಕಣೆ', 'Agriculture': 'ಕೃಷಿ',
  ...
  ta: {
    ...
    'Services / Commercial Transport': 'சேவைகள் / வணிக போக்குவரத்து',
    'Services / Repair Shop': 'பழுதுபார்ப்பு & சேவை மையம்', 'Street Vending': 'தெருவோர வியாபாரம்',
    'Education / Youth': 'கல்வி / இளைஞர்', 'Differently Abled / Divyangjan': 'மாற்றுத்திறனாளி மேம்பாடு',
    'Women Entrepreneur': 'பெண் தொழில்முனைவோர்', 'Commercial Transport': 'வணிக போக்குவரத்து',
    ...
    'Food Processing / Culinary': 'உணவு பதப்படுத்தல்', 'Artisans & Craftsmen': 'கைவினைஞர்கள்',
    'Handloom & Textiles': 'கைத்தறி & ஜவுளி', 'Fisheries': 'மீன்வளம்',
    'Dairy & Poultry': 'பால் பண்ணை & கோழி வளர்ப்பு', 'Agriculture': 'விவசாயம்',
  ...
  mr: {
    ...
    'Services / Commercial Transport': 'सेवा / व्यावसायिक वाहतूक',
    'Services / Repair Shop': 'दुरुस्ती व सेवा केंद्र', 'Street Vending': 'फेरीवाले व हातगाडी',
    'Education / Youth': 'शिक्षण / तरुण पिढी', 'Differently Abled / Divyangjan': 'दिव्यांग सशक्तीकरण',
    'Women Entrepreneur': 'महिला उद्योजक', 'Commercial Transport': 'व्यावसायिक वाहतूक',
    ...
    'Food Processing / Culinary': 'अन्न प्रक्रिया', 'Artisans & Craftsmen': 'कारागीर व हस्तकलाकार',
    'Handloom & Textiles': 'हातमाग व वस्त्रोद्योग', 'Fisheries': 'मत्स्यपालन',
    'Dairy & Poultry': 'दुग्धव्यवसाय व कुक्कुटपालन', 'Agriculture': 'शेती',
  ...
  bn: {
    ...
    'Services / Commercial Transport': 'সেবা / বাণিজ্যিক পরিবহন',
    'Services / Repair Shop': 'মেরামত ও সার্ভিস সেন্টার', 'Street Vending': 'রাস্তার হকার ও ঠেলাগাড়ি',
    'Education / Youth': 'শিক্ষা / যুব সমাজ', 'Differently Abled / Divyangjan': 'প্রতিবন্ধী সক্ষমতা',
    'Women Entrepreneur': 'মহিলা উদ্যোক্তা', 'Commercial Transport': 'বাণিজ্যিক পরিবহন',
    ...
    'Food Processing / Culinary': 'খাদ্য প্রক্রিয়াকরণ', 'Artisans & Craftsmen': 'কারিগর ও হস্তশিল্পী',
    'Handloom & Textiles': 'তাঁত ও বস্ত্র শিল্প', 'Fisheries': 'মৎস্য পালন',
    'Dairy & Poultry': 'দুগ্ধ ও মুরগি পালন', 'Agriculture': 'কৃষি',
